...
contract StarNotary is ERC721 {
    ...
    string public name = "Yoyoyo";
    string public symbol = "YOYOYO";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address u1 = ownerOf(_tokenId1);
        address u2 = ownerOf(_tokenId2);
        //4. Use _transferFrom function to exchange the tokens.
        _transferFrom(u1, u2, _tokenId1);
        _transferFrom(u2, u1, _tokenId2);
    }
